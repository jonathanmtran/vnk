import { Badge, Heading, SimpleGrid, Tab, TabList, TabPanel, TabPanels, Tabs } from '@chakra-ui/react';
  ...
  render() {
    ...
    <>
      ...
      <Tabs variant='enclosed'>
        <TabList>
          <Tab>Upcoming <Badge>{this.state.upcoming.length}</Badge></Tab>
          <Tab>Performed</Tab>
        </TabList>
        <TabPanels>
          <TabPanel>
            ...
            <QueueItem key={item.id} {...item} onPerform={this.handlePerform} onRemove={this.handleRemove} />
            )}
          </TabPanel>
          <TabPanel>
            {this.state.performed.map((item) =>
            <QueueItem key={item.id} {...item} onPerform={this.handlePerform} />
            )}
          </TabPanel>
        </TabPanels>
      </Tabs>
